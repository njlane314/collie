#ifndef CLfitSS_hh_included
#define CLfitSS_hh_included
...
**/
class CLfitSS : public CLcompute {
public:
  /// constructor
  CLfitSS();
  ...
  */
  ...
  // Get or Set the fraction of S1 in terms of f1 = S1 / (S0 + S1), ie how much "BSM" is in the non SM state.
  void setSignalFraction(double frac);
  inline double getSignalFraction() const { return sigFraction_; }

  void setBSMScale(double frac);
  inline double getBSMScale() const { return bsmScale_; }
...
private:
  ...
  static const int MaxKeep_ = (2*1024*1024)/sizeof(double)/2; // allocate 4 MB to this task 
