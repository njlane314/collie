...
void calcLimit(char* outFile, char* inList, char* m){
  ...
  printf("\n************************************************\n");
  printf("Collie Example Fast-Approximation Limit Calculation\n");
