...
{
  // Settings
  TString inName("output/sbnd/bdt_CollieIOfile.root");
  TString outName("output/sbnd/bdt_ClOutput.root");
  ...
  csLim.setCLlevel(0.90); //This is set to 0.90 to be comparable to other limits 
  csLim.setPrecision(0); 
  csLim.setAccuracy(0.0001); 
  csLim.calculateExpected(true);  
  csLim.calculateObserved(false); //I set this to false as I am only interested in the expected limit, I used fake data
  csLim.setNSigma(0);
